...
By default quantifiers are greedy, this means they will try to find the maximum amout of data to match from a string, this may not be useful as you may have repeated structures in the string where you wnat to capture just one instance of a repeated string. 
