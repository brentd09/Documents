...
|'The Dog was sold for 23.56' -replace 'The\s+([a-z]+)\s.+(\d{2,}\\.\d\d)','$1 $$$2' | The result will be Dog $23.56, the $$ is code for escaping a $ sign which will appear before the money value $2|
